...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -2098660628;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<BroadcastInfoJson> localp2PFfiBridgeP2PGetBroadcastInfo();
  ...
  Future<String> localp2PFfiBridgeP2PGetLocalPeerIdAsync();
  ...
  Future<SystemStatusJson> localp2PFfiBridgeP2PGetSystemStatusAsync();
  ...
  Future<void> localp2PFfiBridgeP2PTriggerRefreshAsync();
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<BroadcastInfoJson> localp2PFfiBridgeP2PGetBroadcastInfo() {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_broadcast_info_json,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kLocalp2PFfiBridgeP2PGetBroadcastInfoConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kLocalp2PFfiBridgeP2PGetBroadcastInfoConstMeta =>
      const TaskConstMeta(debugName: "p2p_get_broadcast_info", argNames: []);
  ...
  Future<String> localp2PFfiBridgeP2PGetLocalPeerIdAsync() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kLocalp2PFfiBridgeP2PGetLocalPeerIdAsyncConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kLocalp2PFfiBridgeP2PGetLocalPeerIdAsyncConstMeta =>
      const TaskConstMeta(
        debugName: "p2p_get_local_peer_id_async",
        argNames: [],
      );
  ...
  Future<SystemStatusJson> localp2PFfiBridgeP2PGetSystemStatusAsync() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kLocalp2PFfiBridgeP2PGetSystemStatusAsyncConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kLocalp2PFfiBridgeP2PGetSystemStatusAsyncConstMeta =>
      const TaskConstMeta(
        debugName: "p2p_get_system_status_async",
        argNames: [],
      );
  ...
  Future<void> localp2PFfiBridgeP2PTriggerRefreshAsync() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kLocalp2PFfiBridgeP2PTriggerRefreshAsyncConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kLocalp2PFfiBridgeP2PTriggerRefreshAsyncConstMeta =>
      const TaskConstMeta(debugName: "p2p_trigger_refresh_async", argNames: []);
  ...
  @protected
  BroadcastInfoJson dco_decode_broadcast_info_json(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 4)
      throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
    return BroadcastInfoJson(
  ...
  @protected
  BroadcastInfoJson sse_decode_broadcast_info_json(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  @protected
  void sse_encode_broadcast_info_json(
    BroadcastInfoJson self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
